...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print('Input filename must be given as comandline argument')
        sys.exit(1)
    ...
    simulate_schedule(input_tasks, release, filename, hyper_period, 'RM')
    simulate_schedule(input_tasks, release, filename, hyper_period, 'EDF')
